//NAME - UDAY SHROTRIYA
//ROLL NO - 2201CS87
//ARCHITECTURE LAB PROJECT CS209
...
void Mne_opc_table(){
    ...
    OPC["add"] = {"06", 0};
    OPC["sub"] = {"07", 0};
    OPC["shl"] = {"08", 0};             // 0- NO OPERAND
    OPC["shr"] = {"09", 0};
    OPC["adj"] = {"0A" , 1};            // 1- 1 OPERAND [VALUE]
    OPC["a2sp"] = {"0B" , 0};           // 2- 1 OPERAND [OFFSET]
    OPC["sp2a"] = {"0C" , 0};
    OPC["call"] = {"0D" , 2};
    OPC["return"] = {"0E" , 0};
    OPC["brz"] = {"0F" , 2};
...
// First pass of assembler which uses the functions declared above
	...
	Mne_opc_table();							// Initializing the mnemonics
